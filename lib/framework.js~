var file = require('fs');
var sessions = require('lgx_sessions');
...
var urlParse = function(str,separator2,separator1){
    ...
    for(var y in arr){
        ...
        Object.defineProperty(obj, dat[0], {
            writable: true,     // bêdzie mo¿na ustawic wartoœæ
            enumerable: true,   // bêdzie widaæ w for-in, in
            configurable: true, // bêdzie mo¿na zmieniæ deskryptor
            value:dat[1]
        });
    }
    return obj;
